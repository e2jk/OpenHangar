...
def canonical_entry(fe: "Flight") -> dict[str, str]:
    ...
    return {
        ...
        "engine_time": _fmt_decimal(fe.engine_time, 1),
        ...
        "fuel_added_before_qty": _fmt_decimal(fe.fuel_added_before_qty, 2),
        "fuel_added_before_unit": _fmt_str(fe.fuel_added_before_unit),
        "fuel_added_after_qty": _fmt_decimal(fe.fuel_added_after_qty, 2),
        "fuel_added_after_unit": _fmt_str(fe.fuel_added_after_unit),
        "fuel_remaining_qty": _fmt_decimal(fe.fuel_remaining_qty, 2),
        "oil_added_before_l": _fmt_decimal(fe.oil_added_before_l, 2),
        "oil_added_after_l": _fmt_decimal(fe.oil_added_after_l, 2),
