...
def seed_fleet(tenant_id: int) -> list:
    ...
    for (
        ...
        (
            ...
            1826.0,
            "J. Klein",
            "Cross-country, light turbulence over Vosges",
            "Cross-country",
            time(8, 30),
            time(12, 0),
            1,
        ...
        (
            ...
            1832.2,
            "S. Martin",
            "Training flight, touch-and-go practice",
            "Training",
            time(10, 0),
            time(10, 48),
            6,
    ...
    for exp_date, etype, desc, amount, currency, qty, unit in [
        ...
        (
            _d(date(2024, 3, 2)),
            ExpenseType.PARTS,
            "50 h oil change — Aeroshell 15W-50",
            85.00,
            "EUR",
            None,
            None,
    ...
    for exp_date, etype, desc, amount, currency, qty, unit in [
        ...
        (
            _d(date(2024, 10, 3)),
            ExpenseType.PARTS,
            "Left propeller governor overhaul",
            1450.00,
            "EUR",
            None,
            None,
    ...
    for exp_date, etype, desc, amount, currency, qty, unit in [
        (
            _d(date(2024, 1, 12)),
            ExpenseType.INSURANCE,
            "Annual hull & liability — Generali",
            1950.00,
            "EUR",
            None,
            None,
        ...
        (
            _d(date(2025, 1, 30)),
            ExpenseType.OTHER,
            "Avionics software update — Garmin",
            240.00,
            "EUR",
            None,
            None,
    ...
    db.session.add(
        ShareToken(aircraft_id=c172.id, token=_unique_token(), access_level="summary")
    )
    db.session.add(
        ShareToken(aircraft_id=seminole.id, token=_unique_token(), access_level="full")
    )
...
def _copy_seed_doc(
    src_name: str, label: str, upload_folder: str
...
def seed_pilot_profiles(
    ...
    rows = [
        ...
        (
            ...
            None,
            ip,
            f"Intro — effects of controls, {ip}",
        ),
        (
            _d(date(2017, 4, 22)),
            "PA-28-161 Warrior II",
        ...
        (
            ...
            None,
            ip,
            f"International nav EBCI-LFQQ — {ip}",
        ),
        (
            _d(date(2017, 9, 23)),
            "PA-28-161 Warrior II",
        ...
        (
            ...
            None,
            jk,
            "First solo cross-country EBCI-EBNM",
        ),
        (
            _d(date(2017, 10, 14)),
            "PA-28-161 Warrior II",
        ...
        (
            ...
            None,
            jk,
            "PPL Skills Test — examiner R. Pieters — PASS",
        ),
        ...
        (
            ...
            1.0,
            ic,
            f"Instrument approach practice under foggles — {ic}",
        ),
...
def seed_reservations(aircraft_list: list, user_ids: list[int]) -> None:
    ...
    for ac, start, end, pid, status, notes in entries:
        ...
        rate = (
            float(settings.hourly_rate) if settings and settings.hourly_rate else None
        )
