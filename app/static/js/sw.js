...
var NOT_CACHED_PATTERNS = [
  ...
  [/^\/aircraft\/[A-Z0-9][A-Z0-9-]*\/maintenance\/amp\/export$/, 'printable AMP document snapshot, no repeat-visit value — same reasoning as the personal-minimums print page'],
  ...
  [/^\/aircraft\/[A-Z0-9][A-Z0-9-]*\/owners\/\d+\/account$/, 'shows live account balance — staleness here is about money, not a badge'],
