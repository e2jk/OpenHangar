...
_PACKAGES = [
    {
        ...
        "files": [
            ('bootstrap/css/bootstrap.min.css', 'dist/css/bootstrap.min.css',
             'sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB'),
            ('bootstrap/js/bootstrap.bundle.min.js', 'dist/js/bootstrap.bundle.min.js',
    ...
    },
    {
        ...
        "files": [
            ('bootstrap-icons/font/bootstrap-icons.min.css', 'font/bootstrap-icons.min.css',
             'CK2SzKma4jA5H/MXDUU7i1TqZlCFaD4T01vtyDFvPlD97JQyS+IsSh1nI2EFbpyk'),
            ('bootstrap-icons/font/fonts/bootstrap-icons.woff2', 'font/fonts/bootstrap-icons.woff2',
             'xEoI56EFpIZiDZZKBZxsn3gO3u/FvXtOpHbtkMWmSdfzDw3x9XdVc3i70O9hm4SC'),
            ('bootstrap-icons/font/fonts/bootstrap-icons.woff', 'font/fonts/bootstrap-icons.woff',
    ...
    },
    {
        ...
        "files": [
            ('canvas-confetti/confetti.browser.min.js', 'dist/confetti.browser.min.js',
